...
class admin extends template
{
	...
	public function admin_foot($last_visit = null, $last_ip = null) 
	{
		...
		if(isset($url[1]))
		{
			...
			{			
			$subNav = '<div class="row mg-b"><div class="col-xs-12"><h3 class="no-margin">'.$component_array[$url[1]]['name'].'</h3><small>'.$component_array[$url[1]]['desc'].'</small></div></div>';
			...
			{			
			$subNav = '<div class="row mg-b"><div class="col-xs-12"><h3 class="no-margin">'.$module_array[$url[2]]['name'].'</h3><small>'.$module_array[$url[2]]['desc'].'</small></div></div>';
