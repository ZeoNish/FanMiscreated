...
<html class="js canvas csstransforms csstransforms3d csstransitions video audio localstorage sessionstorage svg inlinesvg">
	<head>	
		...
		<script src="{ADM_THEME}/assets/js/moment-with-locales.min.js"></script>	
		<script src="{ADM_THEME}/assets/js/bootstrap.js"></script>		
		<script src="{ADM_THEME}/assets/js/bootstrap-datetimepicker.min.js"></script>
		...
		<link rel="stylesheet" href="{ADM_THEME}/assets/css/datetimepicker.css">			
	...
	<body>
		<div class="app" data-sidebar="locked">
			<header class="header header-fixed navbar bg-white">
				...
				<ul class="nav navbar-nav navbar-right off-right" style="height:50px;">					
					<li class="notifications dropdown hidden-xs" style="height:50px;">
					...
					<li class="quickmenu mg-r-md" style="height:50px;">
						<a href="#" data-toggle="dropdown" style="height:50px;">
						...
						<ul class="dropdown-menu dropdown-menu-right mg-r-xs">
							...
							<li>
								<a target="_blank" href="http://extras.jmy.su/">[alang:_PANEL_SUNMENU_HELP]</a>
							</li>
							<li class="divider">
							</li>
							<li>
						...
						<ul>
							...
							<li class="dropdown show-on-hover">
								...
								<ul class="dropdown-menu">
									...
									<li>
										<a href="{ADMIN}/module/blog"><span>[alang:_PANEL_MENU_COM_BLOG]</span></a>
									</li>
									<li>
